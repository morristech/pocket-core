...
// GetApplication - Retrieve application with address from the main store
...
// SetApplication - Store a application in the main store
...
// GetApplications - Retrieve a given amount of all the applications
...
// IterateAndExecuteOverApps -Goes through the validator set and executes handler
